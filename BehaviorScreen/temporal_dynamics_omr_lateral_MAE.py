...
sub_df = df[(df['epoch_name'] == "grating break after right") | (df['epoch_name'] == "grating break after left")].copy()
...
plt.tight_layout()
plt.savefig(
    'temporal_dynamics_omr_MAE.svg', 
    bbox_inches='tight'
)
plt.savefig(
    'temporal_dynamics_omr_MAE.png',
    dpi=300, 
    bbox_inches='tight'
)
plt.show()
...
plt.tight_layout()
plt.savefig(
    'temporal_dynamics_omr_MAE_index.svg', 
    bbox_inches='tight'
)
plt.savefig(
    'temporal_dynamics_omr_MAE_index.png',
    dpi=300, 
    bbox_inches='tight'
)
plt.show()